...
const Slider = () => {
  ...
  const getBannerStyle = (index) => {
    const styles = [
      { bg: "from-purple-400 via-purple-500 to-indigo-700", accent: "purple", pattern: "diagonal-waves" },
      { bg: "from-red-400 via-orange-500 to-yellow-500", accent: "orange", pattern: "hexagon-grid" },
      { bg: "from-red-500 via-red-600 to-green-600", accent: "red", pattern: "circuit-lines" },
      { bg: "from-pink-600 via-rose-500 to-pink-400", accent: "pink", pattern: "organic-curves" },
      { bg: "from-yellow-500 via-amber-500 to-orange-500", accent: "yellow", pattern: "geometric-mesh" },
      { bg: "from-sky-600 via-blue-500 to-cyan-500", accent: "blue", pattern: "liquid-waves" },
      { bg: "from-green-500 via-yellow-400 to-red-500", accent: "green", pattern: "neural-network" },
      { bg: "from-red-600 via-amber-300 to-green-700", accent: "emerald", pattern: "crystalline" },
    ];
...
<div className="lg:col-span-7 order-2 lg:order-1 space-y-4 sm:space-y-8 text-center lg:text-left">
                    ...
                    <div className="relative inline-flex items-center gap-2 sm:gap-3 px-4 sm:px-6 py-2 sm:py-3">
                      <svg className="absolute inset-0 w-full h-full" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <rect width="100%" height="100%" rx="20" fill="url(#badge-grad)" stroke="rgba(255,255,255,0.3)" strokeWidth="1"/>
                      </svg>
                    ...
                    <div className="space-y-3 sm:space-y-4 relative">
                      <h1 className="text-2xl sm:text-5xl font-black text-white leading-tight relative">
                        ...
                        <svg className="absolute inset-0 w-full h-full opacity-10" xmlns="http://www.w3.org/2000/svg">
                          <defs>
                            <pattern id="title-texture" patternUnits="userSpaceOnUse" width="20" height="20">
                              <circle cx="10" cy="10" r="1" fill="white" opacity="0.3"/>
                            </pattern>
                          </defs>
                          <rect width="100%" height="100%" fill="url(#title-texture)"/>
                        </svg>
                      </h1>
                    ...
                    <div className="grid grid-cols-3 gap-3 sm:gap-4 lg:gap-6 max-w-sm mx-auto lg:mx-0">
                      {[
                        ...
                        <div key={idx} className="relative text-center p-3 group hover:scale-105 transition-transform duration-300">
                          <svg className="absolute inset-0 w-full h-full" xmlns="http://www.w3.org/2000/svg">
                            <defs>
                              <linearGradient id={`stat-grad-${idx}`} x1="0%" y1="0%" x2="100%" y2="100%">
                                <stop offset="0%" stopColor="rgba(255,255,255,0.15)"/>
                                <stop offset="100%" stopColor="rgba(255,255,255,0.05)"/>
                              </linearGradient>
                            </defs>
                            <rect width="100%" height="100%" rx="8" fill={`url(#stat-grad-${idx})`} 
                    ...
                    <div className="pt-2">
                      <NavLink to={slide.url}>
                        <button className="relative px-8 py-3 sm:px-10 sm:py-4 font-bold text-base sm:text-lg rounded-full group overflow-hidden">
                          <svg className="absolute inset-0 w-full h-full" xmlns="http://www.w3.org/2000/svg">
                            <defs>
                            ...
                            <rect width="100%" height="100%" rx="25" fill="url(#btn-grad)" 
                                  filter="url(#glow)" className="group-hover:drop-shadow-2xl transition-all duration-300"/>
                          </svg>
                          <span className="relative z-10 flex items-center justify-center gap-2 sm:gap-3 text-slate-900 group-hover:scale-105 transition-transform duration-300">
                    ...
                    <div className="relative group">
                      ...
                      <svg className="absolute -inset-4 w-[calc(100%+2rem)] h-[calc(100%+2rem)]" xmlns="http://www.w3.org/2000/svg">
                        <defs>
                          ...
                          <pattern id="frame-pattern" patternUnits="userSpaceOnUse" width="20" height="20">
                            <circle cx="10" cy="10" r="1" fill="rgba(255,255,255,0.1)"/>
                          </pattern>
                        </defs>
                        <rect width="100%" height="100%" rx="20" fill="url(#frame-glow)" stroke="rgba(255,255,255,0.2)" strokeWidth="2"/>
                        <rect width="100%" height="100%" rx="20" fill="url(#frame-pattern)"/>
                      </svg>
